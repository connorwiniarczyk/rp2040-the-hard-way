...
#define GPIO_25_CTRL 0x400140cc
...
int main (void) {
	...
	write_register(GPIO_25_CTRL, 5);

	write_register(SIO_OUTPUT_ENABLE, 1 << 17);
	write_register(SIO_OUTPUT_ENABLE, 1 << 25);

	while (1) {
		write_register(SIO_OUTPUT_XOR, 1 << 17);
		write_register(SIO_OUTPUT_XOR, 1 << 25);
